...
HD_PWD='/home/koitt/Vivado_Workspace/uart/uart.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_system_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_system_wrapper.tcl
