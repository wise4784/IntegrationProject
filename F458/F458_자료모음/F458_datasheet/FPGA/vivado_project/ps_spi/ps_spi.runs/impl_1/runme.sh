...
HD_PWD='/home/roro/fpga_workspace/ps_spi/ps_spi.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ps_spi_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ps_spi_wrapper.tcl -notrace
