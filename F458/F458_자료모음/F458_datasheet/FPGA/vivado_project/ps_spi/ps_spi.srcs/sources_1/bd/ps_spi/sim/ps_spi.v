...
//Date        : Sun Jun  9 22:34:22 2019
//Host        : roro-Lenovo-Y520-15IKBN running 64-bit Ubuntu 16.04.5 LTS
//Command     : generate_target ps_spi.bd
//Design      : ps_spi
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "ps_spi,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=ps_spi,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=2,numReposBlks=2,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "ps_spi.hwdef" *) 
module ps_spi
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  ps_spi_processing_system7_0_0 processing_system7_0
  ...
  ps_spi_xlconstant_0_0 xlconstant_0
