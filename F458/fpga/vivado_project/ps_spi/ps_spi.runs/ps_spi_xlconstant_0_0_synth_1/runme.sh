...
HD_PWD='/home/roro/fpga_workspace/ps_spi/ps_spi.runs/ps_spi_xlconstant_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ps_spi_xlconstant_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ps_spi_xlconstant_0_0.tcl
