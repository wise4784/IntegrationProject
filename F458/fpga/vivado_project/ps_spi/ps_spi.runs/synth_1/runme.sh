...
HD_PWD='/home/roro/fpga_workspace/ps_spi/ps_spi.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ps_spi_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ps_spi_wrapper.tcl
