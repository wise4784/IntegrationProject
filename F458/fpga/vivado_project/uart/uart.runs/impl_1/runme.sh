...
HD_PWD='/home/koitt/Vivado_Workspace/uart/uart.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_system_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source uart_system_wrapper.tcl -notrace
