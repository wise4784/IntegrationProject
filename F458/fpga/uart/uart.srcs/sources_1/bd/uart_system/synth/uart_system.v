...
//Date        : Fri Apr 19 13:27:36 2019
//Host        : koitt-laptop running 64-bit Ubuntu 16.04.5 LTS
//Command     : generate_target uart_system.bd
//Design      : uart_system
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "uart_system,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=uart_system,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "uart_system.hwdef" *) 
module uart_system
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  uart_system_processing_system7_0_0 processing_system7_0
