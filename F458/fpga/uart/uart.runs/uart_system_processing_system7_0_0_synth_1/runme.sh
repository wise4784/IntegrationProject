...
HD_PWD='/home/koitt/Vivado_Workspace/uart/uart.runs/uart_system_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_system_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_system_processing_system7_0_0.tcl
