...
{                      
        ...
        Point pts[6] = {                              
                        Point(329,195), Point(341,182), Point(628,319), Point(633, 417), 
					Point(4, 415),Point(7,354)};                                                                                               
...
int main(int argc, char **argv)
{
	...
	imwrite("sobel_roi.jpg", edge);

	//namedWindow("First Order Differential Image", WINDOW_NORMAL);
