...
HD_PWD='/home/sdr/project/IntegrationProject/mercenary/fpga_sine_wave/fpga_sine_wave.runs/fpga_sine_wave_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fpga_sine_wave_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fpga_sine_wave_auto_pc_0.tcl
