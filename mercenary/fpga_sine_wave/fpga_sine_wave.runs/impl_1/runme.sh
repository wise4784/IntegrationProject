...
HD_PWD='/home/sdr/project/IntegrationProject/mercenary/fpga_sine_wave/fpga_sine_wave.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fpga_sine_wave_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fpga_sine_wave_wrapper.tcl -notrace
