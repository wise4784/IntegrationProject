...
void main(void)
{
    // VCLK3 주파수 37.5Mhz로 설정
    systemREG2->CLK2CNTRL = 0x0000000FU;
	...
	//xTaskCreate(vTask3, "PwmChange", configMINIMAL_STACK_SIZE, NULL, 2, &xTask3Handle);
...
{/*
    ...
    BaseType_t xAlreadyTransmitted = 0, xByteSent = 0;
    TaskHandle_t xRxTask = NULL;
    size_t xLenToSend;

    xRemoteAddress.sin_port = FreeRTOS_htons(4784);
