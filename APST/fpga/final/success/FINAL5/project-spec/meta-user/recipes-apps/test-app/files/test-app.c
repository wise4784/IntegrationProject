...
//			sem_wait(pmodToLidarFlag);
			if(*flag_PmodToLidar)
			{
				printf("Lidar SSSSSSSSSSSSSsstart\n");
				LidarCount++;
				if(LidarCount == 99)
				{
					LidarCount = 0;
